...
def main():
  ...
  if args.dataset == 'aircraft':
    train_data = torchvision.datasets.FGVCAircraft(root='./data', split='train',download=True, 
    transform=train_transform)
    test_data = torchvision.datasets.FGVCAircraft(root='./data', split='val',
                                           download=True, transform=test_transform)
...
# Log sub dataset under consideration.
  ...
  if args.dataset == 'flower102':
    ...
    if args.dataset == 'aircraft':
    total_classes =  ['707-320', '727-200', '737-200', '737-300', '737-400', '737-500', '737-600', '737-700',
     '737-800', '737-900', '747-100', '747-200', '747-300', '747-400', '757-200', '757-300', '767-200', 
     '767-300', '767-400', '777-200', '777-300', 'A300B4', 'A310', 'A318', 'A319', 'A320', 'A321', 'A330-200', 
